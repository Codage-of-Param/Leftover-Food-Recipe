    ...
    <div className="mt-4 w-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-3 px-1">
        ...
        <div className="flex items-center gap-3">
          <div className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full text-xs font-bold text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex gap-1">
            <button 
              ...
              className="w-7 h-7 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 disabled:opacity-30 hover:bg-gray-50 transition-colors shadow-sm"
            >
              ←
            </button>
            <button 
      ...
      <div 
        ...
        className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0"
        style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
      >
        {recipes.map((recipe, idx) => (
          <div key={idx} className="snap-center shrink-0 w-[85%] sm:w-auto h-full flex items-stretch">
